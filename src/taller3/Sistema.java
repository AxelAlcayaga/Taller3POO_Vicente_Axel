	        ...
	        for (Proyecto p : proyectos) {
	            ...
	            if (tareas.isEmpty()) {
	                ...
	                for (Tarea t : tareas) {
	                    ...
	                    if(t.getComplejidad()==null) {
	                    	writer.write("       -> Responsable: " + t.getResponsable() + " | Prioridad: No asignada");
	                    	writer.newLine();
...
public void aplicar_visitor() {
    System.out.println("\n=== EJECUTANDO ANÁLISIS DE TAREAS (VISITOR) ===");
    Visitor_accion visitor = new Visitor_accion();
